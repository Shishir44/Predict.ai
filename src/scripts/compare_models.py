...
class ModelComparator:
    ...
    def plot_comparison(self, metrics: Dict, output_dir: str = "models/comparison") -> None:
        ...
        }).to_csv(output_path / 'model_comparison_metrics.csv', index=False)
    ...
    def plot_predictions(self, X_test: np.ndarray, y_soh_test: np.ndarray, y_soc_test: np.ndarray,
        ...
        plt.legend()
        plt.savefig(output_path / 'soh_prediction_comparison.png')
        plt.close()
        ...
        plt.legend()
        plt.savefig(output_path / 'soc_prediction_comparison.png')
        plt.close()
